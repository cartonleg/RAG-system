...
class QdrantDBProvider(VectorDBInterface):
    ...
    def create_collection(self, collection_name: str,
        ...
        if not self.is_collection_exist(collection_name=collection_name):
            ...
            return True
        self.logger.error("could not create collection because this collection already exists")
        return False
    ...
    def insert_one(self, collection_name: str, text: str,
        ...
        if not self.is_collection_exist:
            self.logger.error("cannot insert new record because collection does not exist")
            return False
    ...
    def search_by_vector(self, collection_name: str, vector: list, limit: int = 7, score_threshold: float = 0.5):
        ...
        return [
            RetrieveDocument(**{"score": result.score, "text": result.payload["text"]})
